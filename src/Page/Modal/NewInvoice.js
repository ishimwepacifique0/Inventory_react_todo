    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <div className="form-group">
            <label for="default" className="col-sm-2 control-label">CustomerTin</label>
            ...
            <div className="form-group">
            <label for="default" className="col-sm-2 control-label">CustomerName</label>
            <div className="col-sm-10">
            <input type="text" name="address" className="form-control"  />
            </div>
            </div>
            ...
            <div className="form-group">
            <label for="default" className="col-sm-2 control-label">CustomerPhonenumber</label>
            <div className="col-sm-10">
            <input type="text" name="address" className="form-control"  />
            </div>
            </div>
            ...
            <input type="text" name="address" className="form-control"  />
                ...
                <div className="form-group">
                    ...
                    <div className="form-group">
                    <label for="default" className="col-sm-2 control-label"> Total Price</label>
                    <div className="col-sm-10">
